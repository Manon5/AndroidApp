    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        level1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                objetbunble.putString("passInfo", "level 2.1n");
        ...
        level2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // objet qui vas nous permettre de passe des variables ici la variable passInfo
                Bundle objetbunble = new Bundle();
                objetbunble.putString("passInfo", "level 2.2n");
                // on passe notre objet a notre activities
                defineIntent.putExtras(objetbunble );
                // on appelle notre activité
                startActivity(defineIntent);
        ...
        level3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // objet qui vas nous permettre de passe des variables ici la variable passInfo
                Bundle objetbunble = new Bundle();
                objetbunble.putString("passInfo", "level 2.3n");
                // on passe notre objet a notre activities
                defineIntent.putExtras(objetbunble );
                // on appelle notre activité
                startActivity(defineIntent);
        ...
        level4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // objet qui vas nous permettre de passe des variables ici la variable passInfo
                Bundle objetbunble = new Bundle();
                objetbunble.putString("passInfo", "level 2.4n");
                // on passe notre objet a notre activities
                defineIntent.putExtras(objetbunble );
                // on appelle notre activité
                startActivity(defineIntent);
        ...
        level5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // objet qui vas nous permettre de passe des variables ici la variable passInfo
                Bundle objetbunble = new Bundle();
                objetbunble.putString("passInfo", "level 2.5n");
                // on passe notre objet a notre activities
                defineIntent.putExtras(objetbunble );
                // on appelle notre activité
                startActivity(defineIntent);
        ...
        level6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // objet qui vas nous permettre de passe des variables ici la variable passInfo
                Bundle objetbunble = new Bundle();
                objetbunble.putString("passInfo", "level 2.6n");
                // on passe notre objet a notre activities
                defineIntent.putExtras(objetbunble );
                // on appelle notre activité
                startActivity(defineIntent);
        ...
        level7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // objet qui vas nous permettre de passe des variables ici la variable passInfo
                Bundle objetbunble = new Bundle();
                objetbunble.putString("passInfo", "level 2.7n");
                // on passe notre objet a notre activities
                defineIntent.putExtras(objetbunble );
                // on appelle notre activité
                startActivity(defineIntent);
        ...
        level8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // objet qui vas nous permettre de passe des variables ici la variable passInfo
                Bundle objetbunble = new Bundle();
                objetbunble.putString("passInfo", "level 2.8n");
                // on passe notre objet a notre activities
                defineIntent.putExtras(objetbunble );
                // on appelle notre activité
                startActivity(defineIntent);
